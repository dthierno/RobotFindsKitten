...
/**
 * La classe NonKitten représente une case qui contient élément non-chaton dans l'environnement de jeu.
 * Elle hérite de la classe Case et permet une interaction avec le robot pour afficher une description.
 */

public class NonKitten extends Case {
    private String descriptive;
    private static int nextDescription = 0;
    ...
    /**
     * Constructeur par défaut de la classe NonKitten.
     * Initialise la représentation de l'objet avec un symbole aléatoire et attribue une description.
     */
    public NonKitten(){
        super.representation = getRandomSymbole();

        // Gestion des descriptions pour éviter les dépassements de tableau
    ...
    /**
     * Obtient la description de l'objet NonKitten.
     *
     * @return La description de l'objet NonKitten.
     */
    ...
    /**
     * Vérifie si une interaction est possible entre l'objet NonKitten et un robot.
     * Cette méthode retourne toujours true car une interaction avec un objet NonKitten est toujours possible.
     *
     * @param robot Le robot avec lequel l'interaction est vérifiée.
     * @return true, car une interaction avec un objet NonKitten est toujours possible.
     */
    @Override
    ...
    /**
     * Méthode d'interaction entre l'objet NonKitten et un robot.
     * Lorsque le robot interagit avec un objet NonKitten, la description de l'objet est affichée.
     *
     * @param robot Le robot avec lequel l'interaction est effectuée.
     */
    @Override
    public void interagir(Robot robot){
        System.out.println(this.descriptive);
    }
}
